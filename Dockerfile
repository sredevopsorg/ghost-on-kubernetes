...
FROM node:jod-bookworm@sha256:3218f0d1b9e4b63def322e9ae362d581fbeac1ef21b51fc502ef91386667ce92 AS build-env
USER root
...
# Stage 2: Final Image
FROM gcr.io/distroless/nodejs22-debian12:latest@sha256:3c90d20cfa08093504ee4795fae9e2571b605dd975b3992e1ef8ccf8b146388a AS runtime 
