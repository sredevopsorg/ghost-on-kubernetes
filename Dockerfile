...
FROM node:iron-bookworm@sha256:a4d1de4c7339eabcf78a90137dfd551b798829e3ef3e399e0036ac454afa1291 AS build-env
USER root
...
# Stage 2: Final Image
FROM gcr.io/distroless/nodejs20-debian12:latest@sha256:40b1db5c38e83ef8245efabcd9b5cbd87e2405eb75afe7fdea60ffb29c1a3289 AS runtime 
