...
FROM docker.io/node:jod-trixie@sha256:e61770466a526ffb31c33ae045beecd3921896ae83a898e48a68b2fca68accae AS build-env
USER root
...
RUN mkdir -pv "$GHOST_INSTALL" || true
...
# Stage 2: Final Image
FROM gcr.io/distroless/nodejs22-debian13:debug-nonroot@sha256:6731730178fd09bd6b0e561407cedd11b791c450aa09042a058b693651668616 AS runtime 
